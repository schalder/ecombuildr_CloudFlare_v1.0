...
<html lang="en">
  <head>
    ...
    <!-- SEO handled by Vercel Middleware -->
...
export default async function middleware(request: NextRequest): Promise<NextResponse> {
  ...
  console.log('Middleware called:', { domain, pathname, userAgent });
  ...
  if (!isCustomDomain) {
    console.log('Not a custom domain, passing through');
    return NextResponse.next();
  }
  ...
  try {
    ...
    if (seoData) {
      ...
      return new NextResponse(dynamicHTML, {
        headers: { 
