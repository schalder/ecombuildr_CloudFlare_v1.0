...
const faqData = [
  ...
  },
  {
    ...
    answer: "হ্যাঁ, নিশ্চয়ই! আমাদের টেমপ্লেটগুলো বাংলা-রেডি। আপনি চাইলে লেখাগুলো নিজে এডিট করতে পারেন, আর বাংলা ফন্ট (যেমন Noto Sans Bengali) আমরা সাপোর্ট করি। এমনকি প্রি-ফিলড বাংলা কনটেন্টসহ একটি স্টার্টার প্যাকও পাবেন চাইলে।"
  },
  {
    question: "সেলস ফানেল আবার কী জিনিস?",
    answer: "সেলস ফানেল মানে হলো এমন কিছু পেজের সিকোয়েন্স—ল্যান্ডিং → চেকআউট → পোস্ট-পারচেজ অফার—যা গ্রাহককে ধাপে ধাপে গাইড করে কেনাকাটা শেষ করতে। এর ফলে কনভার্সন বাড়ে আর অর্ডারের ভ্যালুও বাড়ে।"
  },
  {
  ...
  {
    question: "ওয়ান-ক্লিক আপসেল/ডাউনসেল সাপোর্ট আছে?",
    answer: "হ্যাঁ। পেমেন্টের পর অফার এক ক্লিকেই নেওয়া যাবে, আবার এড়িয়ে যাওয়া যাবে কোনো ঝামেলা ছাড়াই।"
  },
  {
    question: "কোন কোন পেমেন্ট গেটওয়ে ও কুরিয়ার সাপোর্ট করে?",
    answer: "বেশ কিছু পেমেন্ট গেটওয়ে আর কুরিয়ার ইন্টিগ্রেটেড আছে। সেটিংস থেকে কানেক্ট করলেই পেমেন্ট কালেক্ট ও ডেলিভারি শুরু করতে পারবেন।"
  },
  {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            আমাদের সবচেয়ে জনপ্রিয় প্রশ্নগুলোর উত্তর এখানে পাবেন
          </p>
        </div>
