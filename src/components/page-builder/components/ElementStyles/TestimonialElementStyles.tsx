...
export const TestimonialElementStyles: React.FC<TestimonialElementStylesProps> = ({
  element,
  onStyleUpdate,
}) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <TypographyGroup
        ...
        prefix="testimonial"
        isOpen={testimonialTypographyOpen}
        setIsOpen={setTestimonialTypographyOpen}
      ...
      <TypographyGroup
        title="Author Name"
        prefix="author"
        isOpen={authorTypographyOpen}
        setIsOpen={setAuthorTypographyOpen}
        defaultFontSize="16px"
      />
