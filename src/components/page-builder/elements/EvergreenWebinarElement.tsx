...
const chatMessagePool = [
  ...
  "নোট নিচ্ছি",
  "গোল্ডেন ইনফরমেশন 🔥",
  "অনেক চাপ নিচ্ছি, স্যার 😅",
  "এটা জানতাম না, অনেক কিছু শিখলাম",
  "সত্যি অসাধারণ লাগছে",
  "Real business knowledge এটা আমার জন্য খুব কাজে লাগবে",
  ...
  "ekhon asol game ta bujte perechi",
  "ওয়াও, একদম মাইন্ড ব্লোয়িং",
  "sir, আপনাকে follow করি",
  ...
  "স্যার, আপনি কয় বছর ধরে কাজ করছেন?",
  "আমি এখনো লাইভ আছি",
  "ওহহ এখন বুঝতে পারলাম!",
  "One-man army 😅 আমিই সব করি",
  ...
  "ধীরে বলেন স্যার, নোট নিচ্ছি",
  "এটা তো একদম আমার সমস্যার সলিউশন",
  "আমার নেট একটু স্লো, রিপ্লে পাবো?",
  "আমি থাকছি শেষ পর্যন্ত",
  "অসাধারণ প্রেজেন্টেশন",
  "স্যার, লাইভ চ্যাটে রেসপন্স দিতে পারবেন?",
  ...
  "আপনি কি এই প্রেজেন্টেশনের PDF দিবেন?",
  ...
  "Value for money webianr",
  "শেষ পর্যন্ত থাকবো, খুব ভালো লাগছে"
];

const fakeNames = [
  "রফিকুল ইসলাম", "সাবরিনা সুলতানা", "মাহমুদুল হাসান", "তানজিলা আক্তার", "ইমরান",
  "মেহজাবিন রহমান", "জসিম", "ফারহানা আক্তার", "সাদিকুর রহমান", "মাহমুদা খাতুন",
  "রিজওয়ান", "শারমিন সুলতানা", "তানভীর আহমেদ", "মাহী আক্তার", "নাসিম",
  "রুবাইয়া খান", "মোশাররফ হোসেন", "সুবর্ণা", "শফিকুল ইসলাম", "মিম আক্তার",
  "রাশেদুল ইসলাম", "সামিয়া হোসেন", "আরিফুল ইসলাম", "সাদিয়া সুলতানা", "রুবেল মিয়া",
  "ফারজানা", "সৈকত আহমেদ", "নুসরাত জাহান", "মাসুম বিল্লাহ", "অর্পিতা সেন",
  "শাকিল", "মাহীর ইসলাম"
];
...
export const EvergreenWebinarElement: React.FC<{
  ...
  useEffect(() => {
    // Don't track time in edit mode (prevents redirects and other time-based features)
    if (!isPlaying || isEditing || (!enableCTA && !enableScheduledMessages && !enableRedirect)) {
      return;
    }
    ...
    videoTimeIntervalRef.current = setInterval(() => {
      setVideoTime((prev) => {
        ...
        // Handle redirect - only once, and only if URL is provided (isEditing already checked above)
        if (enableRedirect && newTime >= redirectTime && redirectUrl && !hasRedirectedRef.current) {
