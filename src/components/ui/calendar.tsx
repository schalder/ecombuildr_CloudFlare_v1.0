    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 bg-background border border-border p-0 opacity-70 hover:opacity-100 hover:bg-accent transition-colors"
        ),
        ...
        day_today: "bg-accent text-accent-foreground font-semibold border border-border",
        day_outside:
