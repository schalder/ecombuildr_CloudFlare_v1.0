...
-- Create partial unique index to ensure only one homepage per domain
CREATE UNIQUE INDEX idx_unique_homepage_per_domain 
ON public.domain_connections(domain_id) 
WHERE is_homepage = true;

-- Create unique index to ensure unique path per domain
CREATE UNIQUE INDEX idx_unique_path_per_domain 
