...
try {
  ...
  const hasEdgeRuntime = vercelConfig.functions && 
    ...
    (vercelConfig.functions['api/[...catchall]/index.ts'].runtime === 'edge@1.0.0' || 
...
try {
  ...
  if (edgeConfigExists) {
    ...
    console.log(`✅ Edge runtime configured: ${edgeConfig.runtime === 'edge@1.0.0' || edgeConfig.runtime === '@vercel/edge' || edgeConfig.runtime === 'edge'}`);
  }
} catch (error) {
